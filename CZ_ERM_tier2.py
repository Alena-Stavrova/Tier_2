...
class OrderContextCZ(ParentContext):
    def __init__(self):
        ...
        self.sku_lists = {
            'price_classes': {
                0: [83836, 83820, 84547, 84545, 83089], # Under 3000 CZK

                1: [84652, 84088, 84648, 84553, 83837] # 3000+ CZK
            }
        }
...
def place_order():
    ...
    try:
        ...
        #print(f"Found checkout button")
        print("Found checkout button, attempting to click...")
...
def main_cz_erm(email, phone, emails=None, order_counter=0):
    global driver, wait
