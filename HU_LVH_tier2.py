...
def generate_test_plan(order):
    ...
    # Greedy approach: for each delivery, cover as many uncovered payments as possible
    for delivery in third_party_deliveries:
        ...
        if compatible_third_party:
            # Take all compatible payments for this delivery
            chosen_payment = compatible_third_party[0]  # You could be smarter here
